...
def project_lexicon_constructs() -> list[N.Note]:
    ...
    C = {
        ...
        "item": ("An ITEM is the SOURCE-AGNOSTIC resolution unit of the lexicon layer: a segment "
                 ...
                 "regardless of origin. INPUT items resolve from open-domain corpora (e.g. FinePDFs); "
                 "OUTPUT items resolve from generated corpora (e.g. chapters) — and output items "
                 "resolve against the Canonical Aperture via the SAME admission procedures employed "
                 "during input admission (RH 2026-07-19). Chapters are not a different kind of object "
                 "here: they RESOLVE to items.\n\nConsequence: input-side and output-side analysis "
                 "(anchor-topics, spectral topics, congruence) is commensurable BY CONSTRUCTION — "
