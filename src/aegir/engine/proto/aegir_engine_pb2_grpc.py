...
class AegirEngineServicer:
    ...
    def Complete(self, request, context):
        """Workload-facing: request an inference CAPABILITY. The engine selects + ensures the model and calls
        vLLM internally; the workload never sees a vLLM endpoint.
        """
    ...
    def EnsureEndpoint(self, request, context):
        """Admin/observability for the engine-internal vLLM lifecycle (NOT how workloads do inference).
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_AegirEngineServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'aegir.engine.AegirEngine', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('aegir.engine.AegirEngine', rpc_method_handlers)
